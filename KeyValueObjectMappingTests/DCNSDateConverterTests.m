...
- (void) testValidDouble {
  ...
  XCTAssertTrue([convertor validDouble:@"10"], @"Should recognize '10' as a valid double");
  XCTAssertTrue([convertor validDouble:@"10.0"], @"Should recognize '10.0' as a valid double");
  [@[ @"Monday, April 17, 2006", @"Monday, April 17, 2006 2:22:48 PM", @"4/17/2006 2:22:48 PM", @"Mon, 17 Apr 2006 21:22:48 GMT", @"2006-04-17 21:22:48Z", @"2006-04-17T14:22:48.2698750-07:00" ]
   enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
    XCTAssertFalse([convertor validDouble:obj], @"test");
  }];
